package fun.archware.viaversion.gui;

import com.mojang.realmsclient.gui.ChatFormatting;
import fun.archware.viaversion.protocols.ProtocolCollection;
...
public class GuiProtocolSelector extends GuiScreen
{
    ...
    public void drawScreen(int p_drawScreen_1_, int p_drawScreen_2_, float p_drawScreen_3_)
    {
        ...
        this.drawCenteredString(this.fontRendererObj, ChatFormatting.BOLD + "ViaMCP Reborn", this.width / 4, 6, 16777215);
        GL11.glPopMatrix();
    ...
    abstract class SlotList extends GuiSlot
    {
