...
public class GUIMultiString extends GUIElement {
    public double posX, posY;
    public Setting parent;

    public GUIMultiString(double posX, double posY, Setting parent) {
        this.posX = posX;
        this.posY = posY;
        this.parent = parent;
    }
    ...
    public void drawScreen(int mouseX, int mouseY) {
        ...
        for(final String value : parent.getSelectedValues()){
            if(ClickGUI.font2.getStringWidth(stringBuilder + ", " + value.toLowerCase()) < 55){
        ...
        ClickGUI.font2.drawStringWithOutline(stringBuilder.toString(), ClickGUI.X + posX + 11, ClickGUI.Y + ClickGUI.scissor + posY + 10, -1);
