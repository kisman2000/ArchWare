...
import fun.archware.impl.modules.misc.CustomTime;
...
public class WorldInfo
{
    ...
    {
        return ArchWare.moduleManager.getModuleByClass(CustomTime.class).isToggled() ? (long)ArchWare.settingManager.getSettingById("CustomTime").getValueNumeric() : this.worldTime;
    }
