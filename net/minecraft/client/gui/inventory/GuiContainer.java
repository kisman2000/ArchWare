...
public abstract class GuiContainer extends GuiScreen
{
    ...
    public static float animTicks, addition, lastTime;
    ...
    protected void onDrawGuiContainerBackgroundLayer() {
        addition = (lastTime < mc.timer.field_194147_b ? mc.timer.field_194147_b - lastTime : (lastTime != mc.timer.field_194147_b ? 1 - lastTime + mc.timer.field_194147_b : 0));

        if(animTicks<20)
            animTicks += Math.min(addition/1.5*(20.5-animTicks), 20-animTicks);

        GlStateManager.translate(this.width/2f, this.height/2f, 1);
        GlStateManager.scale(animTicks*0.05, animTicks*0.05, animTicks*0.05);
        GlStateManager.translate(-(this.width/2f), -(this.height/2f), 1);
        lastTime  = mc.timer.field_194147_b;
    }
