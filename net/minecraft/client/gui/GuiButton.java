...
public class GuiButton extends Gui
{
    ...
    public void func_191745_a(Minecraft p_191745_1_, int p_191745_2_, int p_191745_3_, float p_191745_4_)
    {
        if (this.visible)
        {
            ...
            Gui.drawRect(this.xPosition, this.yPosition, this.xPosition + width, this.yPosition + height, new Color(opacity, opacity, opacity, 205).hashCode());
            if(this.hovered){
                opacity = 53;
            }else{
                opacity = 25;
            ...
            font.drawCenteredString(this.displayString, this.xPosition + this.width / 2 - 1, this.yPosition + (this.height - 8) / 2 + 2, j);
        }
    }
