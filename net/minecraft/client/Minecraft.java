...
import fun.archware.impl.events.EventMouseScrool;
...
public class Minecraft implements IThreadListener, ISnooperInfo
{
    ...
    public void displayGuiScreen(@Nullable GuiScreen guiScreenIn, final String login, final GuiScreen prevScreen) throws SQLException {
        if (this.currentScreen != null)
        {
            this.currentScreen.onGuiClosed();
        }
    ...
    public void runTick() throws IOException
    {
        ...
        final EventTick eventTick = new EventTick(getRenderPartialTicks());
        eventTick.call();
    ...
    private void runTickMouse() throws IOException
    {
        while (Mouse.next())
        {
            ...
            if (j <= 200L)
            {
                ...
                if (k != 0)
                {
                    final EventMouseScrool eventMouseScrool = new EventMouseScrool(k);
