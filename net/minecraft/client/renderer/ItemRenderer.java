...
import fun.archware.impl.modules.render.ViewModel;
...
public class ItemRenderer
{
    ...
    private void transformSideFirstPerson(EnumHandSide p_187459_1_, float p_187459_2_)
    {
        ...
        if(ArchWare.moduleManager.getModuleByClass(ViewModel.class).isToggled()){
    ...
    public void renderOverlays(float partialTicks)
    {
        ...
        if (!this.mc.player.isSpectator())
        {
            ...
            if (this.mc.player.isBurning() && !Reflector.callBoolean(Reflector.ForgeEventFactory_renderFireOverlay, this.mc.player, partialTicks) && !(ArchWare.moduleManager.getModuleByName("NoRender").isToggled() && ArchWare.settingManager.getSettingById("NoRenderFire").getValueBoolean()))
            {
