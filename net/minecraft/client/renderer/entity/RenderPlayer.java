...
import fun.archware.impl.modules.render.Chams;
...
public class RenderPlayer extends RenderLivingBase<AbstractClientPlayer>
{
    ...
    {
        if(ArchWare.moduleManager.getModuleByClass(Chams.class).isToggled()){
            glPushMatrix();
            ...
            switch(ArchWare.settingManager.getSettingById("ChamsMode").getValueString()){
                case "Static":
                    glColor4f((int)ArchWare.settingManager.getSettingById("ChamsRed").getValueNumeric() / 255f, (int)ArchWare.settingManager.getSettingById("ChamsGreen").getValueNumeric() / 255f, (int)ArchWare.settingManager.getSettingById("ChamsBlue").getValueNumeric() / 255f, (int)(ArchWare.settingManager.getSettingById("ChamsOpacity").getValueNumeric() / ArchWare.settingManager.getSettingById("ChamsOpacity").getMaxValue()) * 184 / 255f);
                    break;
                case "Pulsive":
                    Color color = RenderUtil.fade(new Color((int)ArchWare.settingManager.getSettingById("ChamsRed").getValueNumeric(), (int)ArchWare.settingManager.getSettingById("ChamsGreen").getValueNumeric(), (int)ArchWare.settingManager.getSettingById("ChamsBlue").getValueNumeric()), 1, 1);
        ...
        if(ArchWare.moduleManager.getModuleByName("Chams").isToggled()){
