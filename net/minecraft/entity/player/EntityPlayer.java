...
import fun.archware.impl.modules.misc.Freecam;
import fun.archware.impl.modules.movement.NoClip;
...
public abstract class EntityPlayer extends EntityLivingBase
{
    ...
    {
        this.noClip = ArchWare.moduleManager.getModuleByClass(Freecam.class).isToggled() ||  ArchWare.moduleManager.getModuleByClass(NoClip.class).isToggled() || this.isSpectator();
